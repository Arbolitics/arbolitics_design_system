# CLAUDE.md — Arbolitics Design System Gem
...
harness. No React, no Stimulus, no asset pipeline other than Propshaft
and a standalone Tailwind v4 binary.
...
| `app/assets/builds/arbolitics_design_system.css` | compiled output — served in browser |

Rebuild command:
```
tailwindcss -i app/assets/tailwind/application.css \
            -o app/assets/builds/arbolitics_design_system.css
```
